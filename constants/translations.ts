export const translations = {
    en: {
        ...
        habitName: "Habit Name", markDone: "Mark as Done", done: "Done",
    ...
    id: {
        ...
        habitName: "Nama Kebiasaan", markDone: "Tandai Selesai", done: "Selesai",
...
export const CHART_COLORS = ['#3B82F6', '#10B981', '#F59E0B', '#EF4444', '#8B5CF6', '#EC4899', '#06B6D4', '#6366F1'];
